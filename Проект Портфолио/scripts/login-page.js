...
function setTheme(isDark) {
    if (isDark) {
        document.querySelector('.log-in').style.background = 'rgba(53, 53, 54, 1)';
        document.querySelector('.log-in').style.border = '2px solid rgba(245, 245, 247, 1)';
        ...
        document.querySelector('.log-in').style.background = '#F5F5F7';
        document.querySelector('.log-in').style.border = '2px solid #353536';
        document.querySelectorAll('.form-field')
